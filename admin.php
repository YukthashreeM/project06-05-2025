...
<body>
    <aside class="sidebar">
        ...
        <div class="info">
            ...
            <div><i class="fas fa-building"></i> <span>Department: Admin</span></div>
            <div><i class="fas fa-user-tie"></i> <span>Designation: Admin</span></div>
    ...
    <main class="main">
        ...
        <section class="dashboard-cards">
            <a href="manage_users1.php" class="card">
            ...
            <a href="payroll.php" class="card">
                ...
                <h4>Payroll</h4>
                <p>View the payroll</p>
            </a>
            <a href="payslip.php" class="card">
                <i class="fas fa-receipt"></i>
                <h4>View Payslip</h4>
                <p>View the payslip</p>
            </a>
        </section>
